...
class TokenPredictor:
    ...
    def _load_and_preprocess_data(self, main, assets, directory="./data/"):
        ...
        y = x['High'].shift(-1).to_list()

        todays_current_high = json.load(open(todays_dir.format('GBTC')))['high']
        y.pop(0)
        y.append(todays_current_high)
    ...
    def _create_model(self, input_shape):
        ...
        # Add input layer
        model.add(Dense(units=64, activation='relu', input_shape=input_shape[1:]))
    ...
    def train(self, directory='./data/'):
        ...
        self._create_model(x_train.shape)
